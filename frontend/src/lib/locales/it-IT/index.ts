...
export const itIT = {
  ...
  sources: {
    ...
    bulkEmbedInProgress: "Accodamento vectorizzazione...",
    embedFilterLabel: "Filtro vectorizzazione",
    embedFilterAll: "Vectorizzazione: tutte",
    embedFilterMissing: "Non vectorizzate",
    embedFilterEmbedded: "Vectorizzate",
    embeddingInProgress: "Vettorizzazione in corso",
    embeddingCanceling: "Arresto in corso...",
    stopEmbedTooltip: "Ferma vettorizzazione",
    bulkStopEmbedSelected: "Ferma vettorizzazione di {{count}} selezionati",
    bulkStopEmbedConfirmTitle: "Ferma vettorizzazione",
    bulkStopEmbedConfirmDesc: "Fermare i lavori di vettorizzazione delle {{count}} fonti selezionate? I lavori già completati non sono interessati.",
    embedCancelSuccess: "Richiesta di arresto della vettorizzazione inviata",
    embedCancelNone: "Niente da fermare: il lavoro di vettorizzazione è già completato",
    embedCancelFailed: "Arresto della vettorizzazione non riuscito",
    bulkEmbedSelected: "Vectorizza {{count}} selezionati",
    bulkEmbedConfirmTitle: "Rivectorizzare",
    bulkEmbedConfirmDesc: "Accodare i lavori di vectorizzazione per {{count}} fonte/i selezionate? Le fonti già indicizzate verranno ricostruite.",
    bulkEmbedQueuedSuccess: "{{count}} fonte/i accodate per la vectorizzazione.",
  ...
  advanced: {
    ...
    rebuild: {
      ...
      missing: "Solo mancanti",
      missingDesc: "Vectorizza solo gli elementi con contenuto ma senza indice vettoriale (lavori falliti o saltati). Gli indici esistenti non vengono toccati.",
  ...
  models: {
    ...
    reasoningGroupModels: "Modelli",
    reasoningGroupLabel: "Livello di ragionamento",
    reasoningDefault: "Predefinito (segui il modello)",
    reasoningLevel: {
      off: "Disattivato",
      low: "Basso",
      medium: "Medio",
