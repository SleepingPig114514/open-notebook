...
export const zhCN = {
  ...
  sources: {
    ...
    refreshContent: "刷新内容",
    removeFromSources: "从来源中移除",
    removeFromSourcesConfirm: "确定从来源中移除吗？该来源会从所有笔记本中移除，磁盘上的原文件不会被删除。",
    retry: "重试",
    ...
    uploadFile: "上传文件",
    enterText: "输入文本",
    titleSearchPlaceholder: "按标题或路径关键字搜索...",
    selectAllFiltered: "全选筛选结果",
    filteredCount: "显示 {{count}} 条",
    tooManySources: "来源过多，结果已截断。",
    bulkDeleteInProgress: "正在移除来源...",
    bulkEmbedInProgress: "正在提交向量化任务...",
    embedFilterLabel: "向量化状态筛选",
    ...
    bulkStopEmbedSelected: "停止向量化所选 {{count}} 项",
    bulkStopEmbedConfirmTitle: "停止向量化",
    bulkStopEmbedConfirmDesc: "确定停止所选 {{count}} 个来源的向量化任务吗？已完成的任务不受影响。",
    embedCancelSuccess: "已提交停止向量化请求",
    embedCancelNone: "任务已完成，无需停止",
    embedCancelFailed: "停止向量化任务失败",
    bulkEmbedSelected: "向量化所选 {{count}} 项",
    bulkEmbedConfirmTitle: "重新向量化",
    bulkEmbedConfirmDesc: "为选中的 {{count}} 个来源提交向量化任务？已有向量的来源会重建索引。",
    bulkEmbedQueuedSuccess: "已为 {{count}} 个来源提交向量化任务。",
    bulkSearchPlaceholder: "按标题/路径关键字筛选来源...",
    selectAll: "全选",
    bulkActions: "已选 {{count}} 项",
    bulkRemoveNotebookConfirm: "确定将 {{count}} 个来源从本笔记本移除吗？来源仍保留在来源库中，可重新添加。",
    bulkRemoveSourcesConfirm: "确定将 {{count}} 个来源从来源库中移除吗？它们会从所有笔记本消失，但磁盘上的原文件不会被删除。",
    bulkRemovedNotebookSuccess: "已从笔记本移除 {{count}} 个来源。",
    bulkRemovedSourcesSuccess: "已从来源库移除 {{count}} 个来源。",
    bulkFailed: "批量操作失败，没有项目被处理。",
    bulkPartialFail: "{{success}} 个成功，{{failed}} 个失败。",
    importFolder: "导入文件夹",
    importFolderDescription: "把本地文件夹中所有支持的文件导入。重复操作即为同步：新增文件会被添加，修改的文件会重建，已删除文件对应的来源会被移除。",
    folderPathLabel: "文件夹路径",
    folderPathPlaceholder: "例如 D:\\知识库\\我的笔记",
    folderPathHint: "本机绝对路径。文件保留在原位置，直接读取。",
    recursiveLabel: "包含子文件夹",
    importingFolder: "正在导入文件夹...",
    folderImportSummary: "文件夹已同步：新增 {{added}}，更新 {{updated}}，删除 {{deleted}}，未变化 {{unchanged}}",
  ...
  advanced: {
    ...
    rebuild: {
      ...
      missing: "仅缺失项",
      missingDesc: "只向量化有正文但没有向量的条目（如失败或被跳过的任务），不影响已有向量。",
      include: "包含在重建中",
