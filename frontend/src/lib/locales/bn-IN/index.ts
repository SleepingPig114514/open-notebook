...
export const bnIN = {
  ...
  sources: {
    ...
    bulkEmbedInProgress: "ভেক্টরাইজেশন কিউ করা হচ্ছে...",
    embedFilterLabel: "ভেক্টরাইজেশন ফিল্টার",
    embedFilterAll: "ভেক্টরাইজেশন: সব",
    embedFilterMissing: "ভেক্টরাইজ করা হয়নি",
    embedFilterEmbedded: "ভেক্টরাইজ করা হয়েছে",
    embeddingInProgress: "ভেক্টরাইজ হচ্ছে",
    embeddingCanceling: "থামানো হচ্ছে...",
    stopEmbedTooltip: "ভেক্টরাইজেশন থামান",
    bulkStopEmbedSelected: "নির্বাচিত {{count}}টির ভেক্টরাইজেশন থামান",
    bulkStopEmbedConfirmTitle: "ভেক্টরাইজেশন থামান",
    bulkStopEmbedConfirmDesc: "নির্বাচিত {{count}}টি উৎসের ভেক্টরাইজেশন কাজ থামানো হবে? ইতিমধ্যে সম্পন্ন কাজ প্রভাবিত হবে না।",
    embedCancelSuccess: "ভেক্টরাইজেশন থামানোর অনুরোধ পাঠানো হয়েছে",
    embedCancelNone: "থামানোর কিছু নেই - ভেক্টরাইজেশন কাজ ইতিমধ্যে শেষ হয়েছে",
    embedCancelFailed: "ভেক্টরাইজেশন থামানো যায়নি",
    bulkEmbedSelected: "নির্বাচিত {{count}}টি ভেক্টরাইজ করুন",
    bulkEmbedConfirmTitle: "পুনরায় ভেক্টরাইজ করুন",
    bulkEmbedConfirmDesc: "নির্বাচিত {{count}}টি উৎসের জন্য ভেক্টরাইজেশন কাজ কিউ করবেন? যাদের ইতিমধ্যে ভেক্টর ইনডেক্স আছে তারা পুনর্নির্মাণ হবে।",
    bulkEmbedQueuedSuccess: "{{count}}টি উৎস ভেক্টরাইজেশন কিউতে যোগ হয়েছে।",
  ...
  advanced: {
    ...
    rebuild: {
      ...
      missing: "শুধু অনুপস্থিতগুলো",
      missingDesc: "যাদের কনটেন্ট আছে কিন্তু ভেক্টর ইনডেক্স নেই (ব্যর্থ বা এড়ানো কাজ) শুধু তাদের ভেক্টরাইজ করে। বিদ্যমান ইনডেক্স অক্ষত থাকে।",
  ...
  models: {
    ...
    reasoningGroupModels: "মডেল",
    reasoningGroupLabel: "যুক্তির স্তর",
    reasoningDefault: "ডিফল্ট (মডেল অনুসরণ)",
    reasoningLevel: {
      off: "বন্ধ",
      low: "কম",
      medium: "মাঝারি",
