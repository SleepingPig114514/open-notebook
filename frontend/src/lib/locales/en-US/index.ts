export const enUS = {
  ...
  sources: {
    ...
    bulkEmbedInProgress: "Queueing vectorization...",
    embedFilterLabel: "Vectorization filter",
    embedFilterAll: "Vectorization: all",
    embedFilterMissing: "Not vectorized",
    embedFilterEmbedded: "Vectorized",
    embeddingInProgress: "Vectorizing",
    embeddingCanceling: "Stopping...",
    stopEmbedTooltip: "Stop vectorization",
    bulkStopEmbedSelected: "Stop vectorizing {{count}} selected",
    bulkStopEmbedConfirmTitle: "Stop Vectorization",
    bulkStopEmbedConfirmDesc: "Stop the vectorization jobs of the {{count}} selected sources? Already finished jobs are unaffected.",
    embedCancelSuccess: "Vectorization job stopped",
    embedCancelNone: "Nothing to stop - the vectorization job already finished",
    embedCancelFailed: "Failed to stop vectorization job",
    bulkEmbedSelected: "Vectorize {{count}} selected",
    bulkEmbedConfirmTitle: "Re-vectorize",
    bulkEmbedConfirmDesc: "Queue vectorization jobs for {{count}} selected source(s)? Sources that already have a vector index will be rebuilt.",
    bulkEmbedQueuedSuccess: "{{count}} source(s) queued for vectorization.",
  ...
  advanced: {
    ...
    rebuild: {
      ...
      missingDesc: "Embed only items that have content but no vector index yet (e.g. failed or skipped jobs). Existing embeddings are untouched.",
  ...
  models: {
    ...
    reasoningGroupLabel: "Reasoning level",
