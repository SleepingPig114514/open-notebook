...
export const esES = {
  ...
  sources: {
    ...
    bulkEmbedInProgress: "Encolando vectorización...",
    embedFilterLabel: "Filtro de vectorización",
    embedFilterAll: "Vectorización: todos",
    embedFilterMissing: "Sin vectorizar",
    embedFilterEmbedded: "Vectorizado",
    embeddingInProgress: "Vectorizando",
    embeddingCanceling: "Deteniendo...",
    stopEmbedTooltip: "Detener vectorización",
    bulkStopEmbedSelected: "Detener vectorización de {{count}} seleccionados",
    bulkStopEmbedConfirmTitle: "Detener vectorización",
    bulkStopEmbedConfirmDesc: "¿Detener los trabajos de vectorización de las {{count}} fuentes seleccionadas? Los trabajos ya finalizados no se ven afectados.",
    embedCancelSuccess: "Solicitud de parada de vectorización enviada",
    embedCancelNone: "Nada que detener: el trabajo de vectorización ya terminó",
    embedCancelFailed: "Error al detener la vectorización",
    bulkEmbedSelected: "Vectorizar {{count}} seleccionados",
    bulkEmbedConfirmTitle: "Revectorizar",
    bulkEmbedConfirmDesc: "¿Encolar trabajos de vectorización para {{count}} fuente(s) seleccionadas? Las fuentes con índice existente se reconstruirán.",
    bulkEmbedQueuedSuccess: "{{count}} fuente(s) encoladas para vectorización.",
  ...
  advanced: {
    ...
    rebuild: {
      ...
      missingDesc: "Vectoriza solo elementos con contenido pero sin índice de vectores (p. ej. trabajos fallidos u omitidos). No afecta los índices existentes.",
  ...
  models: {
    ...
    reasoningGroupModels: "Modelos",
    reasoningGroupLabel: "Nivel de razonamiento",
    reasoningDefault: "Predeterminado (seguir al modelo)",
    reasoningLevel: {
      off: "Desactivado",
      low: "Bajo",
      medium: "Medio",
