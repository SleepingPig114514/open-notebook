...
export const ruRU = {
  ...
  sources: {
    ...
    bulkEmbedInProgress: "Постановка векторизации в очередь...",
    embedFilterLabel: "Фильтр векторизации",
    embedFilterAll: "Векторизация: все",
    embedFilterMissing: "Не векторизованы",
    embedFilterEmbedded: "Векторизованы",
    embeddingInProgress: "Векторизация",
    embeddingCanceling: "Остановка...",
    stopEmbedTooltip: "Остановить векторизацию",
    bulkStopEmbedSelected: "Остановить векторизацию выбранных: {{count}}",
    bulkStopEmbedConfirmTitle: "Остановить векторизацию",
    bulkStopEmbedConfirmDesc: "Остановить задачи векторизации для выбранных источников ({{count}})? Завершённые задачи не пострадают.",
    embedCancelSuccess: "Запрос на остановку векторизации отправлен",
    embedCancelNone: "Останавливать нечего — задача векторизации уже завершена",
    embedCancelFailed: "Не удалось остановить векторизацию",
    bulkEmbedSelected: "Векторизовать {{count}} выбранных",
    bulkEmbedConfirmTitle: "Перевекторизовать",
    bulkEmbedConfirmDesc: "Поставить задачи векторизации в очередь для {{count}} выбранных источников? Источники с существующим индексом будут перестроены.",
    bulkEmbedQueuedSuccess: "{{count}} источник(ов) добавлено в очередь на векторизацию.",
  ...
  advanced: {
    ...
    rebuild: {
      ...
      missingDesc: "Векторизует только элементы с содержимым, но без векторного индекса (неудачные или пропущенные задачи). Существующие индексы не затрагиваются.",
  ...
  models: {
    ...
    reasoningGroupModels: "Модели",
    reasoningGroupLabel: "Уровень размышлений",
    reasoningDefault: "По умолчанию (как у модели)",
    reasoningLevel: {
      off: "Выкл.",
      low: "Низкий",
      medium: "Средний",
