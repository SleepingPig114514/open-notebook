...
export const ptBR = {
  ...
  sources: {
    ...
    bulkEmbedInProgress: "Enfileirando vetorização...",
    embedFilterLabel: "Filtro de vetorização",
    embedFilterAll: "Vetorização: todas",
    embedFilterMissing: "Sem vetorização",
    embedFilterEmbedded: "Vetorizadas",
    embeddingInProgress: "Vetorizando",
    embeddingCanceling: "Parando...",
    stopEmbedTooltip: "Parar vetorização",
    bulkStopEmbedSelected: "Parar vetorização de {{count}} selecionados",
    bulkStopEmbedConfirmTitle: "Parar vetorização",
    bulkStopEmbedConfirmDesc: "Parar os trabalhos de vetorização das {{count}} fontes selecionadas? Trabalhos já concluídos não são afetados.",
    embedCancelSuccess: "Solicitação de parada da vetorização enviada",
    embedCancelNone: "Nada para parar - o trabalho de vetorização já terminou",
    embedCancelFailed: "Falha ao parar a vetorização",
    bulkEmbedSelected: "Vetorizar {{count}} selecionados",
    bulkEmbedConfirmTitle: "Revetorizar",
    bulkEmbedConfirmDesc: "Enfileirar tarefas de vetorização para {{count}} fonte(s) selecionada(s)? Fontes com índice existente serão reconstruídas.",
    bulkEmbedQueuedSuccess: "{{count}} fonte(s) na fila para vetorização.",
  ...
  advanced: {
    ...
    rebuild: {
      ...
      missing: "Somente ausentes",
      missingDesc: "Vetoriza apenas itens com conteúdo mas sem índice vetorial ainda (tarefas falhas ou ignoradas). Índices existentes não são alterados.",
  ...
  models: {
    ...
    reasoningGroupLabel: "Nível de raciocínio",
    reasoningDefault: "Padrão (seguir o modelo)",
    reasoningLevel: {
      off: "Desativado",
      low: "Baixo",
      medium: "Médio",
