...
export const frFR = {
  ...
  sources: {
    ...
    bulkEmbedInProgress: "Mise en file de la vectorisation...",
    embedFilterLabel: "Filtre de vectorisation",
    embedFilterAll: "Vectorisation : toutes",
    embedFilterMissing: "Non vectorisées",
    embedFilterEmbedded: "Vectorisées",
    embeddingInProgress: "Vectorisation",
    embeddingCanceling: "Arrêt en cours...",
    stopEmbedTooltip: "Arrêter la vectorisation",
    bulkStopEmbedSelected: "Arrêter la vectorisation de {{count}} sélection(s)",
    bulkStopEmbedConfirmTitle: "Arrêter la vectorisation",
    bulkStopEmbedConfirmDesc: "Arrêter les travaux de vectorisation des {{count}} sources sélectionnées ? Les travaux terminés ne sont pas affectés.",
    embedCancelSuccess: "Demande d'arrêt de vectorisation envoyée",
    embedCancelNone: "Rien à arrêter - la tâche de vectorisation est déjà terminée",
    embedCancelFailed: "Échec de l'arrêt de la vectorisation",
    bulkEmbedSelected: "Vectoriser {{count}} sélectionné(s)",
    bulkEmbedConfirmTitle: "Revectoriser",
    bulkEmbedConfirmDesc: "Enfiler les tâches de vectorisation pour {{count}} source(s) sélectionnée(s) ? Les sources déjà indexées seront reconstruites.",
    bulkEmbedQueuedSuccess: "{{count}} source(s) mise(s) en file pour vectorisation.",
  ...
  advanced: {
    ...
    rebuild: {
      ...
      missing: "Éléments manquants uniquement",
      missingDesc: "Vectorise uniquement les éléments avec contenu mais sans index vectoriel (tâches échouées ou ignorées). Les index existants sont préservés.",
  ...
  models: {
    ...
    reasoningGroupModels: "Modèles",
    reasoningGroupLabel: "Niveau de raisonnement",
    reasoningDefault: "Par défaut (suivre le modèle)",
    reasoningLevel: {
      off: "Désactivé",
      low: "Faible",
      medium: "Moyen",
