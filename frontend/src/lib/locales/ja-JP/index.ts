...
export const jaJP = {
  ...
  sources: {
    ...
    bulkEmbedInProgress: "ベクトル化をキューに追加中...",
    embedFilterLabel: "ベクトル化フィルター",
    embedFilterAll: "ベクトル化：すべて",
    embedFilterMissing: "未ベクトル化",
    embedFilterEmbedded: "ベクトル化済み",
    embeddingInProgress: "ベクトル化中",
    embeddingCanceling: "停止中...",
    stopEmbedTooltip: "ベクトル化を停止",
    bulkStopEmbedSelected: "選択された {{count}} 件のベクトル化を停止",
    bulkStopEmbedConfirmTitle: "ベクトル化を停止",
    bulkStopEmbedConfirmDesc: "選択した {{count}} 件のソースのベクトル化ジョブを停止しますか？完了済みのジョブは影響を受けません。",
    embedCancelSuccess: "ベクトル化ジョブの停止を要求しました",
    embedCancelNone: "タスクは既に完了しているため、停止できません",
    embedCancelFailed: "ベクトル化ジョブの停止に失敗しました",
    bulkEmbedSelected: "選択された {{count}} 件をベクトル化",
    bulkEmbedConfirmTitle: "再ベクトル化",
    bulkEmbedConfirmDesc: "選択した {{count}} 件のソースのベクトル化ジョブをキューに追加しますか？既にインデックスがあるソースは再構築されます。",
    bulkEmbedQueuedSuccess: "{{count}} 件をベクトル化キューに追加しました。",
  ...
  advanced: {
    ...
    rebuild: {
      ...
      missing: "未処理のみ",
      missingDesc: "コンテンツがあるのにベクトルインデックスが無い項目だけをベクトル化します（失敗・スキップされたジョブなど）。既存のベクトルは変更されません。",
      include: "再構築に含める",
  ...
  models: {
    ...
    reasoningGroupModels: "モデル",
    reasoningGroupLabel: "推論レベル",
