...
export const zhTW = {
  ...
  sources: {
    ...
    removeFromSources: "從來源中移除",
    removeFromSourcesConfirm: "確定從來源中移除嗎？該來源會從所有筆記本中移除，磁碟上的原檔案不會被刪除。",
    retry: "重試",
    ...
    uploadFile: "上傳檔案",
    enterText: "輸入文字",
    titleSearchPlaceholder: "按標題或路徑關鍵字搜尋...",
    selectAllFiltered: "全選篩選結果",
    filteredCount: "顯示 {{count}} 筆",
    tooManySources: "來源過多，結果已截斷。",
    bulkDeleteInProgress: "正在移除來源...",
    bulkEmbedInProgress: "正在提交向量化任務...",
    embedFilterLabel: "向量化狀態篩選",
    embedFilterAll: "向量化：全部",
    embedFilterMissing: "未向量化",
    embedFilterEmbedded: "已向量化",
    embeddingInProgress: "向量化中",
    embeddingCanceling: "正在停止...",
    stopEmbedTooltip: "停止向量化",
    bulkStopEmbedSelected: "停止向量化所選 {{count}} 項",
    bulkStopEmbedConfirmTitle: "停止向量化",
    bulkStopEmbedConfirmDesc: "確定停止所選 {{count}} 個來源的向量化任務嗎？已完成的任務不受影響。",
    embedCancelSuccess: "已提交停止向量化請求",
    embedCancelNone: "任務已完成，無需停止",
    embedCancelFailed: "停止向量化任務失敗",
    bulkEmbedSelected: "向量化所選 {{count}} 項",
    bulkEmbedConfirmTitle: "重新向量化",
    bulkEmbedConfirmDesc: "為選取的 {{count}} 個來源提交向量化任務？已有向量的來源將重建索引。",
    bulkEmbedQueuedSuccess: "已為 {{count}} 個來源提交向量化任務。",
    bulkSearchPlaceholder: "按標題/路徑關鍵字篩選來源...",
    selectAll: "全選",
    bulkActions: "已選 {{count}} 項",
    bulkRemoveNotebookConfirm: "確定將 {{count}} 個來源從本筆記本移除嗎？來源仍保留在來源庫中，可重新加入。",
    bulkRemoveSourcesConfirm: "確定將 {{count}} 個來源從來源庫中移除嗎？它們會從所有筆記本消失，但磁碟上的原始檔不會被刪除。",
    bulkRemovedNotebookSuccess: "已從筆記本移除 {{count}} 個來源。",
    bulkRemovedSourcesSuccess: "已從來源庫移除 {{count}} 個來源。",
    bulkFailed: "批次操作失敗，沒有項目被處理。",
    bulkPartialFail: "{{success}} 個成功，{{failed}} 個失敗。",
    importFolder: "匯入資料夾",
    importFolderDescription: "把本機資料夾中所有支援的檔案匯入。重複操作即為同步：新增檔案會被加入，修改的檔案會重建，已刪除檔案對應的來源會被移除。",
    folderPathLabel: "資料夾路徑",
    folderPathPlaceholder: "例如 D:\\知識庫\\我的筆記",
    folderPathHint: "本機絕對路徑。檔案保留在原位置，直接讀取。",
    recursiveLabel: "包含子資料夾",
    importingFolder: "正在匯入資料夾...",
    folderImportSummary: "資料夾已同步：新增 {{added}}，更新 {{updated}}，刪除 {{deleted}}，未變化 {{unchanged}}",
  ...
  advanced: {
    ...
    rebuild: {
      ...
      missing: "僅缺失項",
      missingDesc: "只向量化有內文但尚無向量的條目（如失敗或被跳過的任務），不影響既有向量。",
      include: "包含在重建中",
  ...
  models: {
    ...
    sttModelDesc: "用於音訊轉錄",
    reasoningGroupModels: "模型",
    reasoningGroupLabel: "推理檔位",
    reasoningDefault: "預設（跟隨模型）",
    reasoningLevel: {
      off: "關閉",
      low: "低",
      medium: "中",
