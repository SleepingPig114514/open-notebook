...
本仓库为 [Open Notebook 官方原版（github.com/lfnovo/open-notebook）](https://github.com/lfnovo/open-notebook) 的**本地定制版**，基于官方 **v1.14.0（commit `3127f14`）**。本文件只说明与官方版本的差异；官方原版的功能介绍、安装与使用文档见同目录 [`README.upstream.md`](README.upstream.md)（即原版 README，内容未做任何修改）。
